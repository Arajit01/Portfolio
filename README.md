...
To capture additional data, you'll just need to create new columns with titles matching the `name` values exactly from your form inputs. For example, if you want to add first and last name inputs, you'd give them `name` values like so:
